  ...
  <div class="min-h-screen flex">
    ...
    <div class="flex-1 flex flex-col min-w-0">
      ...
      <header class="sticky top-0 z-30 bg-white border-b border-gray-200 h-16 flex items-center px-4 lg:px-6">
        ...
        <div class="flex-1">
          <span class="text-red-600 font-medium text-xs uppercase tracking-wider mr-3 bg-red-50 px-2 py-1 rounded">Super Admin</span>
          <span class="text-gray-900 font-medium text-sm">{{ route.meta?.title || route.name }}</span>
        </div>
      </header>
